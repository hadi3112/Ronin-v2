 ...
 *
 * Usage:
 *   node migrate.js              — runs foundations seed
 *   node migrate.js foundations  — runs foundations seed
 */
...
// ─── CONFIG ────────────────────────────────────────────────────────────────
const CONFIG = {
  // Relative path to your src/content/questions/python directory from __dirname (ronin-migration/)
  CONTENT_ROOT: "../src/content/questions/python",
...
// Import seed modules
const seedFoundations = require("./foundations");
...
async function run() {
  const targetSeed = process.argv[2] || "foundations"; // default to foundations
