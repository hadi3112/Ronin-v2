/**
 * PURPOSE: Renders the primary code editor panel inside the IDE Training page. For Python, it lazily imports the Monaco Editor to avoid bundler bloat in native builds, while C++/JavaScript render syntax-colored placeholder skeletons.
 * DEPENDENCIES: 
 *   - React (v19)
 *   - @monaco-editor/react (via MonacoEditorWrapper.jsx)
 *   - TailwindCSS class styles
 * USAGE CONTEXT: Mounted inside IDETrainingPage.jsx. Integrates with the parent component's active language selection and code execution states.
 */
...
const SKELETON_LINES = {
  ...
  JavaScript: [
    ...
    { num: 4,  tokens: [{ t: 'kw', v: '    for ' }, { t: 'let', v: 'let i = 0; i < nums.length; i++) {' }] },
