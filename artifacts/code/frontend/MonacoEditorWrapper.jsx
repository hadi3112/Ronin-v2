/**
 * PURPOSE: Web-only Monaco Editor wrapper rendering the interactive VS-Dark code environment. It isolates the CDN fetch and editor options to keep it split from native compile paths.
 * DEPENDENCIES: 
 *   - React (v19)
 *   - @monaco-editor/react
 * USAGE CONTEXT: Mounted inside IDEEditorPanel.jsx. Provides syntax highlighting, auto-layouts, font ligatures, and change/mount callbacks.
 */
