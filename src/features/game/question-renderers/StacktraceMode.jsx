...
export default function StacktraceMode({ payload, disabled, onAnswer, onTimeout }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-amber-500/35 bg-amber-500/10 px-3 py-2">
        <span className="text-xs font-semibold uppercase tracking-widest text-amber-100/90">Trace stays visible</span>
